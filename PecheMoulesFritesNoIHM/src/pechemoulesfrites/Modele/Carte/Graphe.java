...
import pechemoulesfrites.Modele.Carte.PathFinder.AStar;
import pechemoulesfrites.Modele.Carte.PathFinder.Dijkstra;
import pechemoulesfrites.Modele.Carte.PathFinder.DijkstraSaut;
import pechemoulesfrites.Modele.Carte.PathFinder.Enum_PathFinder;
import pechemoulesfrites.Modele.Carte.PathFinder.IPathFinder;
...
public class Graphe{
    ...
    @Override
    public Graphe clone(){
        Graphe res = new Graphe(largeur, hauteur);
