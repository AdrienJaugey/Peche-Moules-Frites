...
//            System.out.println(p1(i)+"\t"+p2(i)+"\t"+d1(i)+"\t"+d2(i)+"\t");
//        }
//        System.out.println("-----------------------------------");
    ...
    private void initialisation(){
        for(int i = 0; i < Gestionnaire.getGraphe().getNbSommet(); i++){
            ...
            d1(i, Integer.MAX_VALUE-1); //On initialise distance à une valeur assez grande
            d2(i, Integer.MAX_VALUE-1);
            lastPath[i] = -1;
...
//            for(int i = 0;i<Gestionnaire.getGraphe().getNbSommet();i++){ //Pour tout les sommets
//                if(!traité[i]){ //Si celui-ci n'est pas marqué
//                    if(d2(i) < dMin){ //Si sa distance est strictement inférieure à la plus petite pour l'instant trouvée
//                        dMin = d2(i); //On met à jour la distance minimale
//                        indMin = i; //On met à jour l'indice du sommet ayant la distance minimale
//                    }
//                }
//            }
...
//        int sommetSaut = -1, ecartSommetSaut = 0;
//            while(sommet != -1){
//            if(p1(sommet) != -1){
//                sommet = p1(sommet);
//            } else {
//                if(Math.abs(d1(sommet)-d2(sommet)) > ecartSommetSaut){
//                    ecartSommetSaut = Math.abs(d1(sommet)-d2(sommet));
//                    sommetSaut = sommet;
//                }
//                sommet = p2(sommet);
//            }
...
//        sommet = arrivee;
//        while(sommet != -1){
//            if(sommet == sommetSaut || p1(sommet) == -1){
