...
import static pechemoulesfrites.Modele.Enum.Enum_IA.IA_leatoire;
...
public class IA_leatoire extends IA{
     ...
     * @param perso le Personnage associé à l'IA
     ...
     */    
    public IA_leatoire(Personnage perso, double CoeffDistance, double CoeffScore, double CoeffAdversaireProche, double c4) {
        super(IA_leatoire, perso);
